...
export const FinalMenu: FC = () => {
    ...
    const [time, setTime] = useState<
        "breakfast" | "lunch" | "dinner" | "everyday" | undefined
    ...
    return (
        <>
            <MealSearch setDiningHall={setDiningHall} setDate={setDate} setTime={setTime} handleSubmit={handleSubmit} />
            {/* TODO [db] : update MenuItems from static -> response object from backend db
                MenuItems should be a state variable which is updated in handleSubmit */}
            <p>{error}</p>
